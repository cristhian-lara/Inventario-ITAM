...
interface Props {
    editingCecosId: string | null;
    newCecosId: string;
    setNewCecosId: (value: string) => void;
    newCecosName: string;
    setNewCecosName: (value: string) => void;
    newCecosDesc: string;
    setNewCecosDesc: (value: string) => void;
    onClose: () => void;
...
export default function CecosFormModal({
    editingCecosId,
    newCecosId,
    setNewCecosId,
    newCecosName,
